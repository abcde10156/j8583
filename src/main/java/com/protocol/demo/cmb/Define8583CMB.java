 ...
 * Time: 11:06 AM
 */
public class Define8583CMB implements Define8583 {
    ...
    public void defineFieldBody(LinkedHashMap<Integer, Field> fieldBody) {
        ...
        fieldBody.put(64, new FieldVar3(99));
        fieldBody.put(65, new FieldVar3(99));
        fieldBody.put(66, new FieldVar3(99));
        fieldBody.put(70, new FieldVar3(99));
        fieldBody.put(90, new FieldVar3(99));
        fieldBody.put(128, new FieldMac(2));
    }
